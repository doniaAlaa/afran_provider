...
class SizesBottomSheet{
  ...
  openSizesSheet(BuildContext context,dynamic controllerObject,bool addProduct ){
        dynamic controller;
        if(addProduct == true){
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text("اختر الحجم",style: text70016,),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 16.0,vertical: 30),
                    child: Obx((){
                      return controller.sizeLoading.value? CircularProgressIndicator(color: darkPurple,strokeWidth: 1.6,):
                            ...
                            child: ListView.builder(
                              shrinkWrap: true,
                                ...
                                itemBuilder: (context,index){
                                  List<SizeModel> sizes = controller.sizes;
                              return Padding(
                                padding: const EdgeInsets.only(bottom: 16.0),
                                child: InkWell(
                                  onTap: (){
                                    controller.selectedSizeId.value = sizes[index].id??-1;
                                    controller.selectedSize.text = sizes[index].description.toString();
                                  },
                                  child: Obx((){
                                    return Row(
                                      children: [
                                        Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  shape: BoxShape.circle,
                                                  color:controller.selectedSizeId.value == sizes[index].id? darkPurple:null
                                              ),),
                                          ),
                                        ),
                                        SizedBox(width: 16,),
                                        Text(sizes[index].description??''),
                                      ],
                                    );
                                  })
                                ),
